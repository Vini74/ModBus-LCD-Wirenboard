...
- [wb-mqtt-serial](#wb-mqtt-serial)
  ...
  - [Особенности работы драйвера](#особенности-работы-драйвера)
    ...
    - [Прямое чтение и запись в порт](#прямое-чтение-и-запись-в-порт)
      - [Параметры](#параметры)
        - [Обязательные параметры запроса в последовательный порт](#обязательные-параметры-запроса-в-последовательный-порт)
        - [Обязательные параметры запроса в TCP порт](#обязательные-параметры-запроса-в-tcp-порт)
    - [Чтение и запись по протоколу Modbus](#чтение-и-запись-по-протоколу-modbus)
      - [Параметры](#параметры-1)
        - [Обязательные параметры запроса в последовательный порт](#обязательные-параметры-запроса-в-последовательный-порт-1)
        - [Обязательные параметры запроса в TCP порт](#обязательные-параметры-запроса-в-tcp-порт-1)
    ...
    - [Чтение настроек устройств](#чтение-настроек-устройств)
      - [Запрос с указанием типа устройства и параметров порта](#запрос-с-указанием-типа-устройства-и-параметров-порта)
        - [Обязательные параметры запроса в последовательный порт](#обязательные-параметры-запроса-в-последовательный-порт-2)
        - [Обязательные параметры запроса в TCP порт](#обязательные-параметры-запроса-в-tcp-порт-2)
      - [Запрос с указанием идентификатора устройства](#запрос-с-указанием-идентификатора-устройства)
      - [Ответ на запрос](#ответ-на-запрос)
        - [Данные ответа](#данные-ответа)
        - [Описание ошибок](#описание-ошибок)
      - [Кэширование результатов опроса](#кэширование-результатов-опроса)
    - [Чтение каналов и параметров устройств](#чтение-каналов-и-параметров-устройств)
      - [Запрос с указанием типа устройства и параметров порта](#запрос-с-указанием-типа-устройства-и-параметров-порта-1)
        - [Обязательные параметры запроса в последовательный порт](#обязательные-параметры-запроса-в-последовательный-порт-3)
        - [Обязательные параметры запроса в TCP порт](#обязательные-параметры-запроса-в-tcp-порт-3)
      - [Запрос с указанием идентификатора устройства](#запрос-с-указанием-идентификатора-устройства-1)
      - [Ответ на запрос](#ответ-на-запрос-1)
        - [Данные ответа](#данные-ответа-1)
        - [Описание ошибок](#описание-ошибок-1)
    - [Запись каналов и параметров устройств](#запись-каналов-и-параметров-устройств)
      - [Запрос с указанием типа устройства и параметров порта](#запрос-с-указанием-типа-устройства-и-параметров-порта-2)
        - [Обязательные параметры запроса в последовательный порт](#обязательные-параметры-запроса-в-последовательный-порт-4)
        - [Обязательные параметры запроса в TCP порт](#обязательные-параметры-запроса-в-tcp-порт-4)
      - [Запрос с указанием идентификатора устройства](#запрос-с-указанием-идентификатора-устройства-2)
      - [Ответ на запрос](#ответ-на-запрос-2)
        - [Описание ошибок](#описание-ошибок-2)
    - [Управление опросом устройств](#управление-опросом-устройств)
      - [Запрос с указанием типа устройства и параметров порта](#запрос-с-указанием-типа-устройства-и-параметров-порта-3)
        - [Обязательные параметры для последовательного порта](#обязательные-параметры-для-последовательного-порта)
        - [Обязательные параметры для TCP порта](#обязательные-параметры-для-tcp-порта)
      - [Запрос с указанием идентификатора устройства](#запрос-с-указанием-идентификатора-устройства-3)
      - [Ответ на запрос](#ответ-на-запрос-3)
        - [Описание ошибок](#описание-ошибок-3)
